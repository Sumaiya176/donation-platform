      ...
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li>
                <a href="/donations">All Donations Grid</a>
              </li>
              <li>
                <a href="/dashboard/all-donations">All Donations Tabular</a>
              </li>
              <li>
                <a href="/dashboard/create-donation">Create Donation</a>
              </li>
              <li>
                <a href="/dashboard/create-testimonial">Create Testimonial</a>
              </li>
            </ul>
          </div>
          <a
            href="/"
            className="btn btn-ghost text-xl lg:text-3xl text-[tomato]"
          >
            <svg
              width="25"
              height="26"
